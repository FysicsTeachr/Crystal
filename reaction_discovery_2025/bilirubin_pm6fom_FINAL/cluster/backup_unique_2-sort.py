...
# Specify file paths
xyz_file_path = "sorted_all_bili_min.xyz"  # Replace with your XYZ file path
txt_file_path = "unique_1-list.txt"  # Replace with your TXT file path
output_file_path = "unique_2-sort.xyz"  # Replace with your desired output file path

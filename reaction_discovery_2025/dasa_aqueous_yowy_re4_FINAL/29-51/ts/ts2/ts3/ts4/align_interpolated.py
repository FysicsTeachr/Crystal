...
# ------------------------------------------------------------------------------
ref = load_xyz_with_topology('29.xyz')
...
# ------------------------------------------------------------------------------
traj = load_xyz_with_topology('interpolated_29-51.xyz')
...
# ------------------------------------------------------------------------------
traj.save_xyz('aligned_interpolated_29-51.xyz')
print("Alignment complete. Output: aligned_interpolated_29-51.xyz")

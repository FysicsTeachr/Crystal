...
# ------------------------------------------------------------------------------
ref = load_xyz_with_topology('70.xyz')
...
# ------------------------------------------------------------------------------
traj = load_xyz_with_topology('interpolated_70-48s.xyz')
...
# ------------------------------------------------------------------------------
traj.save_xyz('aligned_interpolated_70-48s.xyz')
print("Alignment complete. Output: aligned_interpolated.xyz")

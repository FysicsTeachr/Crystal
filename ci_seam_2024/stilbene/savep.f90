...
Ecut0=-540.94     !!! cutoff energy for accepting lattices.
...
do
  ...
  write(*,*) "energy updated, gogs shuffled"
 ...
 do i=ci,cf
  ...
  do t=1,d
   do tsign = -1,1,2
    ...
    if(qq2(9)<=5 .and. qq2(9)>=-5 .and. qq2(10)<=5 .and. qq2(10)>=-5) then
